...
import './css/ListarLogMotivoParada.css'; // Pode criar um novo arquivo CSS para essa página
import NavBar from './Components/NavBar';
import FormatarDataHoraListar from './Components/FormatarDataHoraListar';

const ListarLogMotivoParada = () => {
  ...
  useEffect(() => {
    ...
    axios.get(process.env.REACT_APP_API_URL + '/InserirLogDetectorParada', {
      headers: {
  ...
  return (
    <div className="logs-container">
      ...
      <div className="logs-content">
        <h2>Log de Motivos de Parada</h2>
        ...
        <table className="logs-table">
          <thead>
            <tr>
              ...
              <th>Código do Motivo de Parada</th>
              <th>Latitude</th>
              <th>Longitude</th>
              <th>PDOP</th>
...
export default ListarLogMotivoParada;
