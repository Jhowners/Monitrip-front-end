...
import './css/ListarLogEventoMotorista.css'; // Pode criar um novo arquivo CSS para essa página
import NavBar from './Components/NavBar';
import FormatarDataHoraListar from './Components/FormatarDataHoraListar';

const ListarLogEventoMotorista = () => {
  ...
  useEffect(() => {
    ...
    axios.get(process.env.REACT_APP_API_URL + '/InserirLogJornadaTrabalhoMotorista', {
      headers: {
  ...
  return (
    <div className="logs-container">
      ...
      <div className="logs-content">
        <h2>Log de Eventos de Motorista</h2>
...
export default ListarLogEventoMotorista;
